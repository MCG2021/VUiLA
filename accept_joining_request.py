...
def approve_joining_request(transaction_executor, request_id):
    ...
    if request_exists(transaction_executor, request_id):
        ...
        if get_value_from_documentid(transaction_executor, Constants.JOINING_REQUEST_TABLE_NAME, request_id, 'isAccepted') == "true" : 
            ...
            join_person_to_company(transaction_executor, scentity_id, person_id)
...
def join_person_to_company(transaction_executor, scentity_id, person_id):
    ...
    statement = 'FROM SCEntities AS s WHERE s.ScentityId = ? INSERT INTO s.PersonIds VALUE ?'
...
if __name__ == '__main__':
    ...
    try:
        with create_qldb_driver() as driver:
            ...
            request_id = "GpIvlDMlHmoLHfaU1RDuUF"        
